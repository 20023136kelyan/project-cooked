...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section className="relative overflow-hidden pt-8 pb-10 sm:pt-12 sm:pb-14 border-b border-orange-100/60 dark:border-zinc-800/80 bg-gradient-to-b from-orange-50/50 via-transparent to-transparent dark:from-zinc-900/30">
